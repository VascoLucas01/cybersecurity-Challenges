...
# Script : Event_Logging_Tool_Part_3_of_3.py
# Purpose: FileHandler should write to a local file; StreamHandler should output to the terminal.
# Why    :
...
def main():
    log_file = 'Event_Logging_Tool_Part_3_of_3.log'
    ...
    logging.info('Starting script Event_Logging_Tool_Part_3_of_3.py...\n')
