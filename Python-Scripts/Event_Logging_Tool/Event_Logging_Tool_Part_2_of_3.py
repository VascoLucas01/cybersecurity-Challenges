...
# Script : Event_Logging_Tool_Part_2_of_3.py
...
def main():
    log_file = 'Event_Logging_Tool_Part_2_of_3.log'
    log_formatter = logging.Formatter('%(asctime)s - %(levelname)s - %(message)s', datefmt='%Y/%d/%m %I:%M:%S %p')

    # Configure log rotation based on size (maxBytes)
    max_bytes = 100
    ...
    logging.info('Starting script Event_Logging_Tool_Part_2_of_3.py...\n')
